<template>
        <div class="number-input fl">
            ...
            <a href="javascript:;" class="btn btn-plus fl" @click="val--" :class="{'btn-disabled':val<=min}">-</a>
            <input type="text" class="number fl" v-model="val" maxlength="8" />
            <a href="javascript:;" class="btn btn-minus fl" @click="val++" :class="{'btn-disabled':val>=max}">+</a>
        </div>
</template>
